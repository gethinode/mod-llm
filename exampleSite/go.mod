...
require (
	...
	github.com/cloudcannon/bookshop/hugo/v3 v3.18.4 // indirect
	github.com/gethinode/hinode/v2 v2.13.2 // indirect
	...
	github.com/gethinode/mod-docs v1.13.3 // indirect
	github.com/gethinode/mod-flexsearch/v4 v4.3.1 // indirect
